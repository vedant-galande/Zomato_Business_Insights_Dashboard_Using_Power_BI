...
### Overview Page
![Overview Dashboard]([./images/overview.png](https://github.com/vedant-galande/Zomato_Business_Insights_Dashboard_Using_Power_BI/blob/main/Dashboard_Page_1.png))

### User Dynamics
![User Dynamics Dashboard]([./images/user_dynamics.png](https://github.com/vedant-galande/Zomato_Business_Insights_Dashboard_Using_Power_BI/blob/main/Dashboard_Page_2.png))

### City-Wise Analysis
![City-Wise Dashboard]([./images/city_analysis.png](https://github.com/vedant-galande/Zomato_Business_Insights_Dashboard_Using_Power_BI/blob/main/Dashboard_Page_3.png))
